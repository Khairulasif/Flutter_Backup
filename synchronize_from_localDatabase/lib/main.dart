...
import 'package:synchronize_from_localdatabase/syncronize.dart';
import 'dart:async';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future isInteret()async{
    await SyncronizationData.isInternet().then((connection){
      if (connection) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Internet connection abailale")));
